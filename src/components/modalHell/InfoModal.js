      ...
      <div className="infoModal">
        <div id={`infoModal__${monsterName}`} className="infoModal__modal">
          <div className="infoModal__modal--open">
            ...
            <div className="infoModal__patrolWin__moneyReward">{heroMoneyConverter(monsterMoneyDrop)} Gained.</div>
            <button
            ...
            <button className="PatrolBattle__backButton" disabled={buttonBoolean} onClick={() => handleBackButton()}>
              Back
            </button>
          </div>
        </div>
