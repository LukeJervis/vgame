  ...
  return (
    <div className="battleLocations">
      <div className="battleLocations__loaction">
        City Outskirts
        <button className="battleLocations__loaction--button" onClick={() => chooseLocation("cityOutskirts")}>
          {" "}
          Patrol
        </button>
      </div>
      <div className="battleLocations__loaction">
        City Plains
        <button className="battleLocations__loaction--button" onClick={() => chooseLocation("cityPlains")}>
          {" "}
          Patrol
        </button>
      </div>
      <div className="battleLocations__loaction">
        Forest
        <button className="battleLocations__loaction--button" onClick={() => chooseLocation("forest")}>
          {" "}
          Patrol
        </button>
      </div>
