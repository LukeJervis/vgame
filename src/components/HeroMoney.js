...
const HeroMoney = () => {
  const {
    countStore: { coinSort, heroMoney, ironCoin, copperCoin, silverCoin, goldCoin },
  } = useRootStore();
  ...
  return (
    <div className="heroMoney__container">
      <img src={ironCoinLogo} className="heroMoneyConverter__coins" height="30px" alt="Iron Coin" title="Iron Coin" />{" "}
      {ironCoin}
      <img
        src={copperCoinLogo}
        className="heroMoneyConverter__coins"
        height="30px"
        alt="Copper Coin"
        title="Copper Coin"
      />{" "}
