...
class SkillStore {
    ...
    itemInv = () => {
        this.skillItems = this.allStores.heroInventoryStore.heroItemsInv.map(
            (heroItemsInv) => (
                <div
                ...
                >
                    ...
                    <div className="HeroInventory__buttonContainer">
                        ...
                        >
                            ...
                            <button
                                key={Math.random().toString(36)}
                                onClick={() => this.tanning(heroItemsInv)}
                            >
                                Tan
                            </button>
                        </div>
    ...
    skillScreen = () => {
        ...
        if (
            ...
            this.allStores.heroActionStore.selectedActionArea = (
                <SkillScreen
                    skill="Tanning"
                    level={this.allStores.countStore.tanningLevel}
                />
            );
        }
    };
    ...
    tanning = (hide) => {
        if (this.tanningActive === true) {
            ...
            this.rawHide = hide;
            this.tanTime =
                hide.hideDiff / this.allStores.countStore.tanningLevel;
            this.tanInterval();
            hide.count--;
            this.itemInv();
            this.skillScreen();
    ...
    tanningProgress = (action) => {
        ...
        if (this.tanningActive === false) {
            ...
            this.tanningProgressState >= this.tanTime &&
            this.tanningActive === true
        ) {
    ...
    tanningComplete = () => {
        ...
        this.itemInv();
        this.allStores.countStore.skillExperienceIncrease(
            "tanning",
            this.rawHide.xp
        );
        this.skillScreen();
